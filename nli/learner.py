...
class Learner(pl.LightningModule):
    def __init__(self, net, ckpt_path):
        super().__init__()
    ...
    def state_dict(self, destination=None, prefix='', keep_vars=False):
        ...
        state_dict.pop('net.embedding.weight')
        return state_dict
    ...
    def on_train_epoch_end(self):
        ...
        if self.val_acc is not None and val_acc < self.val_acc:
            ...
            # save the state_dict
            # self.save_state_dict('best')
            torch.save(self.net.encoder.state_dict(),    f'{self.ckpt_path}/best_encoder.pt')
            if hasattr(self.net.features, 'multiplier'):
                torch.save(self.net.features.state_dict(),   f'{self.ckpt_path}/best_features.pt')
            torch.save(self.net.classifier.state_dict(), f'{self.ckpt_path}/best_classifier.pt')
